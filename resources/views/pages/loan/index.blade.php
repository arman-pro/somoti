    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    @can('loan-create')
                        <a href="{{route('loan.create')}}" class="btn btn-sm btn-success">@lang('Button')</a>
                    @endcan
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <table id="loan_list" class="table table-sm table-striped table-bordered">
                        <thead>
                                ...
                                <td class="text-center">
                                    ...
                                    <div class="btn-group dropleft">
                                        ...
                                        <div class="dropdown-menu" role="menu">
                                            @can('loan-index')
                                                <a class="dropdown-item" href="{{route("loan.show", ['loan' => $loan->id])}}"><i class="fas fa-eye"></i> @lang('View')</a>
                                            @endif
                                            @can('loan-update')
                                                <a class="dropdown-item" href="{{route('loan.edit', ['loan' => $loan->id])}}"><i class="fas fa-edit"></i> @lang('Edit')</a>
                                            @endcan
                                            @can('loan-destroy')
                                                <button type="button" class="dropdown-item delete_btn" data-href="{{route('loan.destroy', ['loan' => $loan->id])}}"><i class="fas fa-trash"></i> @lang('Delete')</button>
                                            @endcan
                                        </div>
                                    </div>
                                    @endcanany
