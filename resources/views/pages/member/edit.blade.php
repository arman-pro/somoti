...
@section('page-header')
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
                <h4 class="m-0">@lang('Edit Member')</h4>
            </div>
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">@lang('Edit Member')</li>
            </ol>
            </div>
        </div>
        </div>
...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <form action="{{route('member.update', ['member' => $member->id])}}" enctype="multipart/form-data" method="post">
                @csrf @method('PUT')
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">@lang('Edit Member')</h4>
                    </div>
                </div>
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="joinDatePickerOne" data-target-input="nearest">
                                        <input type="text" name="join_date" value="{{printDateFormat($member->join_date)}}" placeholder="@lang('Join Date')" data-toggle="joinDatePicker" id="joinDate"  class="form-control form-control-sm @error('join_date') is-invalid @enderror datetimepicker-input" data-target="#joinDatePickerOne" required/>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="member_no" placeholder="@lang('Memebr No')" value="{{$member->member_no}}" id="member_no" class="form-control form-control-sm @error('member_no') is-invalid @enderror ">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="account" placeholder="@lang('A/C No')" value="{{$member->account}}" id="account" class="form-control form-control-sm @error('account') is-invalid @enderror ">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" placeholder="@lang('Name')" value="{{$member->name}}" id="name" class="form-control form-control-sm @error('name') is-invalid @enderror " required>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="tel" name="mobile" placeholder="@lang('Mobile')" value="{{$member->mobile}}" id="mobile" class="form-control form-control-sm @error('mobile') is-invalid @enderror " required/>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="info[father_name]" placeholder="@lang('Father Name')" value="{{optional($extra_info->member_info)->father_name}}" id="father_name" class="form-control form-control-sm @error('info.father_name') is-invalid @enderror "/>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="info[mother_name]" placeholder="@lang('Mother Name')" value="{{optional($extra_info->member_info)->mother_name}}" id="mother_name" class="form-control form-control-sm @error('info.mother_name') is-invalid @enderror "/>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="datetimepicker1" data-target-input="nearest">
                                        <input type="text" name="info[date_of_birth]" value="{{printDateFormat(optional($extra_info->member_info)->date_of_birth)}}" placeholder="@lang('Date Of Birth')" data-toggle="datetimepicker" id="date_of_birth"  class="form-control form-control-sm @error('info.date_of_birth') is-invalid @enderror datetimepicker-input" data-target="#datetimepicker1"/>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select name="info[gender]" id="gender" class="form-control form-control-sm @error('info.gender') is-invalid @enderror">
                                        ...
                                        <option @if(optional($extra_info->member_info)->gender == 'male') selected @endif value="male">@lang('Male')</option>
                                        <option @if(optional($extra_info->member_info)->gender == 'female') selected @endif value="female">@lang('Female')</option>
                                        <option @if(optional($extra_info->member_info)->gender == 'other') selected @endif value="other">@lang('Other')</option>
                                    </select>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select name="info[religion]" id="religion" class="form-control form-control-sm @error('info.religion') is-invalid @enderror">
                                        ...
                                        <option @if(optional($extra_info->member_info)->religion == 'muslim') selected @endif value="muslim">@lang('Muslim')</option>
                                        <option @if(optional($extra_info->member_info)->religion == 'hindu') selected @endif value="hindu">@lang('Hindu')</option>
                                        <option @if(optional($extra_info->member_info)->religion == 'cristan') selected @endif value="cristan">@lang('Cristan')</option>
                                        <option @if(optional($extra_info->member_info)->religion == 'other') selected @endif value="other">@lang("Other")</option>
                                    </select>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="info[profession]" placeholder="@lang('Profession')" value="{{optional($extra_info->member_info)->profession}}" id="profession" class="form-control form-control-sm @error('info.profession') is-invalid @enderror "/>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="info[business_name]" placeholder="@lang('Business Name')" value="{{optional($extra_info->member_info)->business_name}}" id="business_name" class="form-control form-control-sm @error('info.business_name') is-invalid @enderror "/>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address[division]" placeholder="@lang('Division')" value="{{optional($extra_info->member_address->present)->division}}" id="division" class="form-control form-control-sm address @error('address.division') is-invalid @enderror "/>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address[district]" placeholder="@lang('District')" value="{{optional($extra_info->member_address->present)->district}}" id="district" class="form-control form-control-sm address @error('address.district') is-invalid @enderror "/>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address[upzilla]" placeholder="@lang('Thana/Upzilla')" value="{{optional($extra_info->member_address->present)->upzilla}}" id="upzilla" class="form-control form-control-sm address @error('address.upzilla') is-invalid @enderror "/>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address[post_office]" placeholder="@lang('Post Office')" value="{{optional($extra_info->member_address->present)->post_office}}" id="post_office" class="form-control form-control-sm address @error('address.post_office') is-invalid @enderror "/>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address[village]" placeholder="@lang('Village')" value="{{optional($extra_info->member_address->present)->village}}" id="village" class="form-control form-control-sm address @error('address.village') is-invalid @enderror "/>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="permanentAddress[division]" placeholder="@lang('Division')" value="{{optional($extra_info->member_address->permanent)->division}}" id="per_division" class="form-control form-control-sm @error('permanentAddress.division') is-invalid @enderror "/>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="permanentAddress[district]" placeholder="@lang('District')" value="{{optional($extra_info->member_address->permanent)->district}}" id="per_district" class="form-control form-control-sm @error('permanentAddress.district') is-invalid @enderror "/>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="permanentAddress[upzilla]" placeholder="@lang('Thana/Upzilla')" value="{{optional($extra_info->member_address->permanent)->upzilla}}" id="per_upzilla" class="form-control form-control-sm @error('permanentAddress.upzilla') is-invalid @enderror "/>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="permanentAddress[post_office]" placeholder="@lang('Post Office')" value="{{optional($extra_info->member_address->permanent)->post_office}}" id="per_post_office" class="form-control form-control-sm @error('permanentAddress.post_office') is-invalid @enderror "/>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="permanentAddress[village]" placeholder="@lang('Village')" value="{{optional($extra_info->member_address->permanent)->village}}" id="per_village" class="form-control form-control-sm @error('permanentAddress.village') is-invalid @enderror "/>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nominee[name]" placeholder="@lang('Name')" value="{{optional($extra_info->nominee)->name}}" id="nominee_name" class="form-control form-control-sm @error('nominee.name') is-invalid @enderror "/>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nominee[relation]" placeholder="@lang('Relation With Member')" value="{{optional($extra_info->nominee)->relation}}" id="nominee_relation" class="form-control form-control-sm @error('nominee.relation') is-invalid @enderror "/>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nominee[father]" placeholder="@lang('Father Name')" value="{{optional($extra_info->nominee)->father}}" id="nominee_father" class="form-control form-control-sm @error('nominee.father') is-invalid @enderror "/>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nominee[mobile]" placeholder="@lang('Mobile')" value="{{optional($extra_info->nominee)->mobile}}" id="nominee_mobile" class="form-control form-control-sm @error('nominee.mobile') is-invalid @enderror "/>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nominee[division]" placeholder="@lang('Division')" value="{{optional($extra_info->nominee)->division}}" id="nominee_division" class="form-control form-control-sm @error('nominee.division') is-invalid @enderror "/>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nominee[district]" placeholder="@lang('District')" value="{{optional($extra_info->nominee)->district}}" id="nominee_district" class="form-control form-control-sm @error('nominee.district') is-invalid @enderror "/>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nominee[upzilla]" placeholder="@lang('Thana/Upzilla')" value="{{optional($extra_info->nominee)->upzilla}}" id="nominee_upzilla" class="form-control form-control-sm @error('nominee.upzilla') is-invalid @enderror "/>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nominee[post_office]" placeholder="@lang('Post Office')" value="{{optional($extra_info->nominee)->post_office}}" id="nominee_post_office" class="form-control form-control-sm @error('nominee.post_office') is-invalid @enderror "/>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nominee[village]" placeholder="@lang('Village')" value="{{optional($extra_info->nominee)->village}}" id="nominee_village" class="form-control form-control-sm @error('nominee.village') is-invalid @enderror "/>
                                    ...
                                    <div class="card-body">
                                        <?php
                                            if(optional(optional($extra_info->file)->profile)->member) {
                                                $memberProfile = asset('storage/member/' .optional(optional($extra_info->file)->profile)->member);
                                            }else {
                                                $memberProfile = asset('avatar.png');
                                            }
                                        ?>
                                        <img id="memberProfilePreview" src="{{$memberProfile}}" alt="member avatar" class="img-thumbnail m-auto">
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <?php
                                            if(optional(optional($extra_info->file)->profile)->nominee) {
                                                $memberProfile = asset('storage/member/' .optional(optional($extra_info->file)->profile)->nominee);
                                            }else {
                                                $memberProfile = asset('avatar.png');
                                            }
                                        ?>
                                        <img id="nomineeProfilePreview" src="{{$memberProfile}}" alt="nominee avatar" class="img-thumbnail m-auto">
                                    </div>
                                    <div class="card-footer text-center">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#branch').val('{{$member->group->area->branch->id}}').trigger('change');
