...
@section('page-header')
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
            <h4 class="m-0">@lang('Add New Loan')</h4>
            </div>
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">@lang('Add New Loan')</li>
            </ol>
            </div>
        </div>
        </div>
            ...
            <form action="{{route('loan.store')}}" enctype="multipart/form-data" method="post">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">@lang('Add New Loan')</h4>
                    </div>
                </div>
                {{-- member information --}}
                <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" min='0' name="amount" placeholder="@lang('Loan Amount')" value="{{old('amount')}}" id="amount" class="form-control form-control-sm @error('amount') is-invalid @enderror " required />
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" min='0' name="interest" placeholder="@lang('Loan Interest')" value="{{old('interest')}}" id="interest" class="form-control form-control-sm @error('interest') is-invalid @enderror " required />
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" min='0' name="total_amount_payable" placeholder="@lang('Total Amount Payable')" value="{{old('total_amount_payable')}}" id="total_amount_payable" class="form-control form-control-sm @error('total_amount_payable') is-invalid @enderror " required />
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" min='0' name="installment_number" placeholder="@lang('Installment Number')" value="{{old('installment_number')}}" id="installment_number" class="form-control form-control-sm @error('installment_number') is-invalid @enderror " required />
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" min='0' name="installment_amount" placeholder="@lang('Installment Amount')" value="{{old('installment_amount')}}" id="installment_amount" class="form-control form-control-sm @error('installment_amount') is-invalid @enderror " required />
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" min='0' name="insurence_amount" placeholder="@lang('Insurence Amount')" value="{{old('insurence_amount')}}" id="insurence_amount" class="form-control form-control-sm @error('insurence_amount') is-invalid @enderror " required />
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" min='0' name="loan_fee" placeholder="@lang('Loan Fee')" value="{{old('loan_fee')}}" id="loan_fee" class="form-control form-control-sm @error('loan_fee') is-invalid @enderror " required />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="guarantor_name" placeholder="@lang('Guarantor Name')" value="{{old('guarantor_name')}}" id="guarantor_name" class="form-control form-control-sm @error('guarantor_name') is-invalid @enderror "/>
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="guarantor_father" placeholder="@lang('Guarantor Father Name')" value="{{old('guarantor_father')}}" id="guarantor_father" class="form-control form-control-sm @error('guarantor_father') is-invalid @enderror "/>
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="guarantor_relation" placeholder="@lang('Guarantor Relation')" value="{{old('guarantor_relation')}}" id="guarantor_relation" class="form-control form-control-sm @error('guarantor_relation') is-invalid @enderror "/>
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="guarantor_phone" placeholder="@lang('Guarantor Phone')" value="{{old('guarantor_phone')}}" id="guarantor_phone" class="form-control form-control-sm @error('guarantor_phone') is-invalid @enderror "/>
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="bank_account_number" placeholder="@lang('Banck Account Number')" value="{{old('bank_account_number')}}" id="bank_account_number" class="form-control form-control-sm @error('bank_account_number') is-invalid @enderror "/>
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="check_number" placeholder="@lang('Check Number')" value="{{old('check_number')}}" id="check_number" class="form-control form-control-sm @error('check_number') is-invalid @enderror "/>
