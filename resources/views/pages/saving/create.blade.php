                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="voucher_no" placeholder="@lang('Vch. No')"
                                        value="{{ old('voucher_no') }}" id="vch_no"
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    @forelse ($members as $member)
                                        <option data-mobile="{{ $member->mobile }}" data-account="{{ $member->account }}"
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="comment" id="comment"
                                        class="form-control form-control-sm @error('comment') is-invalid @enderror " cols="30" rows="2"
                                        placeholder="@lang('Comment')">{{ old('comment') }}</textarea>
                                    @error('comment')
                                        <p class="m-0 text-danger"><small>{{ $message }}</small></p>
                                    @enderror
                                </div>
