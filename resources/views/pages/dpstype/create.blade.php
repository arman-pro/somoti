...
@section('title', __('Add New DPS Type'))
...
@section('page-header')
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
            <h4 class="m-0">@lang('Add New Dps Type')</h4>
            </div>
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">@lang('Add New DPS Type')</li>
            </ol>
            </div>
        </div>
        </div>
...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <form action="{{route('dpsType.store')}}" method="post">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">@lang('Add New DPS Type')</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
