...
@section('page-header')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4 class="m-0">@lang('FDR Withdraw')</h4>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">@lang('FDR Withdraw')</li>
                    </ol>
                </div>
            </div>
        </div>
...
@section('content')
    <div class="row">
        <div class="col-md-6 col-sm-12">
            <form action="{{route('withdraw.fdr.store')}}" id="fdr-form" method="post">
                @csrf
                <div class="card shadow">
                    <div class="card-header bg-success">
                        <h4 class="card-title">@lang('FDR Withdraw')</h4>
                    </div>
                    <div class="card-body">
...
<script>
    $(document).ready(function() {
        ...
        $('#fdr-form').on('submit', function(evt) {
            evt.preventDefault();
