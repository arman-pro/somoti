    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">@lang('Edit DPS')</li>
            </ol>
            </div>
        </div>
        </div>
...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <form action="{{route('dps.update', ['dp' => $dps->id])}}" method="post">
                @csrf @method('PUT')
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">@lang('Edit DPS')</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                                    ...
                                    <select name="member_id" id="member" class="form-control form-control-sm @error('member_id') is-invalid @enderror" required/>
                                        ...
                                        @forelse ($members as $member)
                                            <option
                                                ...
                                                value="{{$member->id}}"
                                                @if($dps->member_id == $member->id) selected @endif
                                            >{{$member->name}}</option>
                                        @empty
                                        @endforelse
                                    </select>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="account" placeholder="@lang('A/C No')" value="{{$dps->account}}" id="account" class="form-control form-control-sm @error('account') is-invalid @enderror " required/>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="tel" name="mobile" placeholder="@lang('Mobile')" value="{{$dps->mobile}}" id="mobile" class="form-control form-control-sm @error('mobile') is-invalid @enderror "/>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="amount_per_installment" placeholder="@lang('Amount Per Installment')" value="{{$dps->amount_per_installment}}" id="amount_per_installment" class="form-control form-control-sm @error('amount_per_installment') is-invalid @enderror " required/>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="number_of_installment" placeholder="@lang('Number Of Installment')" value="{{$dps->number_of_installment}}" id="number_of_installment" class="form-control form-control-sm @error('number_of_installment') is-invalid @enderror " required/>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="dpstype_id" id="dpstype_id" class="form-control form-control-sm @error('dpstype_id') is-invalid @enderror" required/>
                                        ...
                                        @forelse ($dpsTypes as $dpsType)
                                            <option
                                                data-interest="{{$dpsType->interest_rate}}"
                                                value="{{$dpsType->id}}"
                                                @if($dps->dpstype_id == $dpsType->id) selected @endif
                                            >{{$dpsType->name}} ({{$dpsType->interest_rate}}%)</option>
                                        @empty
                                        @endforelse
                                    </select>
                                    @error('member_id')<p class="m-0 text-danger"><small>{{$message}}</small></p>@enderror
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="fine_missing_dps" placeholder="@lang('Fine Missing DPS')" value="{{$dps->fine_missing_dps}}" id="fine_missing_dps" class="form-control form-control-sm @error('fine_missing_dps') is-invalid @enderror " required/>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="profit" placeholder="@lang('Profit')" value="{{$dps->profit}}" id="profit" class="form-control form-control-sm @error('profit') is-invalid @enderror " required/>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="total_amount" placeholder="@lang('Total Amount')" value="{{$dps->total_amount}}" id="total_amount" class="form-control form-control-sm @error('total_amount') is-invalid @enderror " required/>
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="comment" id="comment" class="form-control form-control-sm @error('total_amount') is-invalid @enderror " cols="30" rows="4" placeholder="@lang('Comment')">{{$dps->comment}}</textarea>
