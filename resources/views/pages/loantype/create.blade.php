...
@section('title', __('Add New Loan Type'))
...
@section('page-header')
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
            <h4 class="m-0">@lang('Add New Loan Type')</h4>
            </div>
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">@lang('Add New Loan Type')</li>
            </ol>
            </div>
        </div>
        </div>
            ...
            <form action="{{route('loanType.store')}}" method="post">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">@lang('Add New Loan Type')</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="day_repay" placeholder="@lang('Day Repay')" value="{{old('day_repay')}}" id="day_repay" class="form-control form-control-sm @error('day_repay') is-invalid @enderror " required/>
