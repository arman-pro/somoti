...
@section('page-header')
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
                <h4 class="m-0">@lang('Edit Savings')</h4>
            </div>
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">@lang('Edit Savings')</li>
            </ol>
            </div>
        </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly name="voucher_no" placeholder="@lang('Vch. No')" value="{{$saving->voucher_no}}" id="vch_no" class="form-control form-control-sm @error('voucher_no') is-invalid @enderror ">
                                    ...
                                    <select name="member_id" id="member" class="form-control form-control-sm @error('member_id') is-invalid @enderror" required/>
                                        ...
                                        @forelse ($members as $member)
                                            <option
                                                ...
                                                value="{{$member->id}}"
                                                @if($member->id == $saving->member_id) selected @endif
                                            >{{$member->name}}</option>
                                        @empty
                                        @endforelse
                                    </select>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="amount" placeholder="@lang('Amount')" value="{{$saving->amount}}" id="amount" class="form-control form-control-sm @error('amount') is-invalid @enderror " required />
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="comment" id="comment" class="form-control form-control-sm @error('total_amount') is-invalid @enderror " cols="30" rows="2" placeholder="@lang('Comment')">{{$saving->comment}}</textarea>
...
<script>
    $(document).ready(function() {
        ...
        $("#member").val("{{$saving->member_id}}").trigger("change");
    });
</script>
@endpush