    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">
                    <a href="{{route('dps.index')}}">@lang("Demo List")</a>
                </li>
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    @can('dps-index')
                        <a href="{{route('dps.index')}}" class="btn btn-sm btn-success">@lang('Button')</a>
                    @endcan
                </div>
            </div>
        </div>
...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <form action="{{route('dps.update', ['dps' => $dps->id])}}" method="post">
                @csrf @method('PUT')
                <div class="card">
